...
class ProfileDataFormViewController: UIViewController {
    ...
    private let displayNameTextField: UITextField = {
        ...
        textField.attributedPlaceholder = NSAttributedString(string: "DisplayName", attributes: [NSAttributedString.Key.foregroundColor: UIColor.gray])
        return textField
    }()
    ...
    override func viewDidLoad() {
        ...
        submitButton.addTarget(self, action: #selector(didTapSubmit), for: .touchDown)
    ...
    private func configuerConstraints() {
        ...
        let submitButtonConstraints = [
            ...
            submitButton.bottomAnchor.constraint(equalTo: view.keyboardLayoutGuide.topAnchor, constant: -20)    // 키보드레이아웃에 맞추는 오토레이아웃
        ]
